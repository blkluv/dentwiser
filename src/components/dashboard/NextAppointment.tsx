import { getUserAppointments } from "@/lib/actions/appointments.action";
...
const NextAppointment = async () => {
  ...
  // get the next appointment (earliest one)
  const nextAppointment = upcomingAppointments[0];

  if (!nextAppointment) return <NoNextAppointments />; // no upcoming appointments
